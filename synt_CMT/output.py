...
from synt_CMT.MT_comps import a2mt
...
def write_rmt_config(event, output_dir, config_dict):
    ...
    config_object = [
        {
            ...
            'INVERSION_SETTINGS': config_dict["INVERSION_SETTINGS"],
            'STATIONS_SELECTION': config_dict["STATIONS_SELECTION"]
        }
    ]
