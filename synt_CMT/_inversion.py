...
from synt_CMT.extras import q_filter, find_exponent
from synt_CMT.MT_comps import a2mt, decompose, decompose_mopad
from synt_CMT.inverse_problem import invert, calc_taper_window, precalc_greens
...
def solution_quality_classification(self, stdev=None, quality_class_1=('A', 'B', 'C', 'D'),
    ...
    if outfile:
        ...
        # plt.text(0, 0, f'{quality_class_1[qi_1]}', ha='center', va='center',
        #          fontsize=200, weight='bold', color=quality_color[qi_1])
        # plt.text(0.75, 0, f'{quality_class_2[qi_2]}', ha='center', va='center',
        #          fontsize=200, weight='bold', color=quality_color[qi_2])
        plt.xlim([-1, 1])
        plt.ylim([-0.9, 1])
        plt.axis('off')
